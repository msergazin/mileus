...
public class RouteServiceImplTest {
    ...
    private RouteResponse routeResponse1;
    private RouteResponse routeResponse2;
...
//        restTemplate = Mockito.mock(RestTemplate.class);
        ...
        routeResponse1 = objectMapper.readValue(getMockJson1(), RouteResponse.class);
        routeResponse1 = objectMapper.readValue(getMockJson2(), RouteResponse.class);
    ...
    public void testFindTheWinnerCar() {
        Mockito.when(restTemplate.getForObject(
                ...
                .thenReturn(routeResponse1);
        Mockito.when(restTemplate.getForObject(
                "http://router.project-osrm.org/route/v1/driving/14.446652,50.084837;14.450142,50.086927;14.455121,50.082659?steps=true&annotations=speed,distance,duration&geometries=geojson", RouteResponse.class))
                .thenReturn(routeResponse2);
